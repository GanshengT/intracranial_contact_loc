function [contact_tbl, shank_model_all, paths] = localize_electrode_gt_small_example(imaging_processing_info_struct, subj_id, opts)
...
%   paths              : struct of generated artifact paths (figures, videos, tables)
%
% Notes
% Disabling any micro wire adjustment as this function is for macro
% localization
% Example
%   [T, S, P] = localize_electrodes(imStruct, 'BJH033');
...
arguments
    ...
    opts.bm_path (1,1) string = 'BJH075_brainmask.auto.mgz';
...
%  downstream code sees the full list
