...
% For batch processing, one should consider adding a reading function that
% reads from a txt or csv files where manufacturer for each electrode is
% stored.
...
[contact_tbl, shank_model_all] = gt_automatic_localize_electrode(im, subj_id, "electrode_manufacture", electrode_manufacture, ...
    "bm_path", bm_path);
